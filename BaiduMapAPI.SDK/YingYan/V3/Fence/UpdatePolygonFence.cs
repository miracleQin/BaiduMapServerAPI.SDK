...
namespace BaiduMapAPI.YingYan.V3.Fence
{
    ...
    /// 更新多边形围栏
    /// </summary>
    public class UpdatePolygonFence : Models.FormDataPostWithoutSNRequest<UpdatePolygonFenceResult>
    {
        /// <summary>
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/fence/updatepolygonfence";
