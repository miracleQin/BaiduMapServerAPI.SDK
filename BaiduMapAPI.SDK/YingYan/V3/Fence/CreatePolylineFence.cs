...
namespace BaiduMapAPI.YingYan.V3.Fence
{
    ...
    /// </para>
    /// </summary>
    public class CreatePolylineFence : Models.FormDataPostWithoutSNRequest<CreatePolylineFenceResult>
    {
        /// <summary>
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/fence/createpolylinefence";
