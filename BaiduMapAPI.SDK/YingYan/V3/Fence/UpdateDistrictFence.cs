...
namespace BaiduMapAPI.YingYan.V3.Fence
{
    ...
    /// 更新行政区划围栏
    /// </summary>
    public class UpdateDistrictFence : Models.FormDataPostWithoutSNRequest<UpdateDistrictFenceResult>
    {
        /// <summary>
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/fence/updatedistrictfence";
