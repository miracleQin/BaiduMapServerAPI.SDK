...
namespace BaiduMapAPI.YingYan.V3.Fence
{
    ...
    /// </para>
    /// </summary>
    public class CreatePolygonFence : Models.FormDataPostWithoutSNRequest<CreatePolygonFenceResult>
    {
        /// <summary>
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/fence/createpolygonfence";
        ...
        /// <para>1. 普通地理围栏：顶点个数在3-100个之间，外接矩形面积&lt;100平方公里<br/>
        /// 2. 大范围地理围栏：顶点个数在3-100个之间，外接矩形面积小于1000平方公里（可覆盖北京五环）。</para>
