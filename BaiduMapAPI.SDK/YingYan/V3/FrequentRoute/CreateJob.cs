...
{
    /// <summary>
    /// 创建一个任务，该任务完成后可通过getjob接口查询计算出的经验路线
    /// <para>该类接口使用方法为：<br/>
    /// 第一步：使用 createjob接口创建任务<br/>
    /// 第二步：使用 getjob接口使用与createjob同样的请求参数定期查询任务状态，一旦返回值中message字段值为“ok”时，则返回计算得出的经验路线。
    /// </para>
    /// </summary>
    public class CreateJob : Models.GetWithoutSNRequest<CreateJobResult>
    {
        /// <summary>
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/frequentroute/createjob";
