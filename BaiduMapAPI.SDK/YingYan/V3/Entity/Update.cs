...
namespace BaiduMapAPI.YingYan.V3.Entity
{
    ...
    public class Update : Models.FormDataPostRequest<UpdateResult>
    {
        ...
        /// 接口地址
        /// </summary>
        public override string URL => "http://yingyan.baidu.com/api/v3/entity/update";
        ...
        /// <para>命名规则：仅支持中文、英文大小字母、英文下划线"_"、英文横线"-"和数字。entity_name 和 entity_desc 支持联合模糊检索。</para>
        /// </summary>
        [Display(Name = "entity_desc")]
        public string EntityDescription { get; set; }

        /// <summary>
        /// 开发者自定义字段
        /// </summary>
        public Dictionary<string, string> CustomColumnValues { get; set; }
    }
}
